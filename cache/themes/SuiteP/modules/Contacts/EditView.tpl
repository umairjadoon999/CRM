...
{/if}  
<input type='text' name='{$fields.portal_password_c.name}' 
id='{$fields.portal_password_c.name}' size='30' 
maxlength='255' 
value='{$value}' title=''      >
</div>
...
addToValidate('EditView', 'portal_password_c', 'varchar', true,'{/literal}{sugar_translate label='LBL_PORTAL_PASSWORD' module='Contacts' for_js=true}{literal}' );
